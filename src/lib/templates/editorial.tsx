// editorial — italic display headings, hairline rule under the contact row.
// Walks the block tree in source order; the divider is a style on the contact
// row itself so template identity stays while source order is preserved.
...
export function EditorialTemplate({ ast, theme }: { ast: ResumeDoc; theme: ResumeTheme }) {
